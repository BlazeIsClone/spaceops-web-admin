<x-default-layout :model="$post">

    <form method="POST" action="{{ route(PostRoutePath::UPDATE, $post) }}" autocomplete="off" id="resource_form">
        @method('put')
        @csrf
        ...
        <div class="d-flex flex-column flex-lg-row">
            <div class="flex-lg-row-fluid mb-10 mb-lg-0 me-lg-7 me-xl-10" id="resource_form_fieldset">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="mb-8">
                                    ...
                                    <x-input-text id="name" name="name" type="text" :value="old('name', $post->name)"
                                        required />
                            ...
                            <div class="col-lg-6">
                                <div class="mb-8">
                                    ...
                                    <x-input-text id="slug" name="slug" type="text" :value="old('slug', $post->slug)"
                                        required />
                        ...
                        <div class="mb-8">
                            ...
                            <x-input-text id="title" name="title" type="text" :value="old('title', $post->title)" required />
                        ...
                        <div class="mb-8">
                            ...
                            <x-input-textarea id="short_description" name="short_description" :maxlength="180"
                                required>{{ old('short_description', $post->short_description) }}</x-input-textarea>
                        ...
                        <div class="row">
                            <div class="col-xl-6">
                                ...
                                <x-input-file id="featured_image" name="featured_image" :value="$post->featuredImage"
                            ...
                            <div class="col-xl-6">
                                ...
                                <x-input-file id="listing_image" name="listing_image" :value="$post->listingImage"
                                    :fileMaxSize="2" />
                ...
                @include('admin.partials.section-meta', ['module' => $post])
            </div>

            <x-form-metadata :model="$post" type="Update">
                <div class="mb-10">
                    ...
                    <x-input-select name="status" data-placeholder="Select Status" data-hide-search="true" required>
                        @foreach (PostStatus::toSelectOptions() as $option)
                            <option value="{{ $option->value }}" @selected($option->value == old('status', $post->status->value))>
                                {{ $option->name }}
                            </option>
                        @endforeach
                    </x-input-select>
